...
train = {}
test = {'190803LiJiayi': FPA_TRIALS[:1]}
# test = {'190803LiJiayi': FPA_TRIALS[:1], '190806SunDongxiao': FPA_TRIALS[:1], '190806WangDianxin': FPA_TRIALS[:1],
#         '190810LiuSensen': FPA_TRIALS[:1], '190813Caolinfeng': FPA_TRIALS[:1], '190813ZengJia': FPA_TRIALS[:1],
#         '190815WangHan': FPA_TRIALS[:1], '190815QiuYue': FPA_TRIALS[:1], '190824ZhangYaqian': FPA_TRIALS[:1],
#         '190816YangCan': FPA_TRIALS[:1], '190820FuZhenzhen': FPA_TRIALS[:1], '190820FuZhinan': FPA_TRIALS[:1]}
